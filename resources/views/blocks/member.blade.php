		...
		<div class="__col grid grid-cols-1 lg:grid-cols-[1.5fr_2fr] gap-20 mt-16">
			<div class="__col">
				...
				<div data-gsap-element="img" class="__img h-full order1">
					<img class="object-cover w-full img-2xl __img radius-img" src="{{ $g_member['image']['url'] }}" alt="{{ $g_member['image']['alt'] ?? '' }}">
				</div>
				@endif
			</div>

			<div class="__member order2 lg:py-10">
				...
				<div data-gsap-element="accordion" class="accordion-wrapper grid mt-10">
					...
					<div class="accordion rounded-2xl bg-white">
				...
				<a data-gsap-element="btn" class="main-btn m-btn align-self-bottom" href="{{ $g_member['button']['url'] }}">{{ $g_member['button']['title'] }}</a>
				@endif
