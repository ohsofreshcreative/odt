...
<section
    ...
    <div class="__wrapper c-main relative">
        ...
        <div x-data="{ activeTab: 0 }" 
             x-init="$nextTick(() => { let h = $refs['tabPanel' + activeTab].offsetHeight; $refs.tabContainer.style.minHeight = h + 'px'; }); $watch('activeTab', () => { $nextTick(() => { let h = $refs['tabPanel' + activeTab].offsetHeight; $refs.tabContainer.style.minHeight = h + 'px'; }); })"
             class="__tabs mt-12">
