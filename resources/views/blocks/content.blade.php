	...
	<div class="__wrapper c-main relative">
		<div class="__col grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
			...
			<div data-gsap-element="img" class="__img h-full order1">
				<img class="object-cover w-full lg:min-h-[440px] __img radius-img" src="{{ $g_content['image']['url'] }}" alt="{{ $g_content['image']['alt'] ?? '' }}">
			</div>
			@endif

			<div class="__content order2 lg:py-10">
				<h4 data-gsap-element="header" class="">{{ $g_content['title'] }}</h4>
