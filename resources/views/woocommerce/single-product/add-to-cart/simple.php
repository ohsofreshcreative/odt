...
if ( $product->is_in_stock() ) : ?>
	...
	<?php do_action( 'woocommerce_before_add_to_cart_form' ); ?>
	   ...
	   <form class="cart flex gap-4 mt-4" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
